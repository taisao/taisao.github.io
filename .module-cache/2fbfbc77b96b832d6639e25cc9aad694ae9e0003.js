	...
	render: function () {
		return (
			React.createElement("div", {className: "why"}, 
                ...
                React.createElement(BlogForm, {handleBlogFromChange: this.handleBlogFromChange, handleBlogFromTitleChange: this.handleBlogFromTitleChange, handleSubmit: this.handleSubmit}), 
